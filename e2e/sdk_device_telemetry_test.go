...
func TestE2E_SDK_Telemetry_DeviceLatencySamples(t *testing.T) {
	...
	_, err = dn.Manager.Exec(ctx, []string{"bash", "-c", `
		...
		doublezero device create --code la2-dz01 --contributor co01 --facility lax --metro xlax --public-ip "207.45.216.134" --dz-prefixes "207.45.216.136/30,200.12.12.12/29" --metrics-publisher ` + la2DeviceAgentPrivateKey.PublicKey().String() + ` --mgmt-vrf mgmt
		doublezero device create --code ny5-dz01 --contributor co01 --facility ewr --metro xewr --public-ip "207.45.21.134" --dz-prefixes "200.12.12.12/29" --metrics-publisher ` + ny5DeviceAgentPrivateKey.PublicKey().String() + ` --mgmt-vrf mgmt
		doublezero device create --code ld4-dz01 --contributor co01 --facility lhr --metro xlhr --public-ip "195.219.120.72" --dz-prefixes "195.219.120.80/29" --mgmt-vrf mgmt
		doublezero device create --code frk-dz01 --contributor co01 --facility fra --metro xfra --public-ip "195.219.220.88" --dz-prefixes "195.219.220.96/29" --mgmt-vrf mgmt
		...
		doublezero link create wan --code "la2-dz01:ny5-dz01" --contributor co01 --side-a la2-dz01 --side-a-interface Switch1/1/1 --side-z ny5-dz01 --side-z-interface Switch1/1/1 --bandwidth "10 Gbps" --delay-ms 40 --jitter-ms 3
		doublezero link update --pubkey "la2-dz01:ny5-dz01" --desired-status activated
		doublezero link create wan --code "ny5-dz01:ld4-dz01" --contributor co01 --side-a ny5-dz01 --side-a-interface Switch1/1/2 --side-z ld4-dz01 --side-z-interface Switch1/1/1 --bandwidth "10 Gbps" --delay-ms 30 --jitter-ms 3
		doublezero link update --pubkey "ny5-dz01:ld4-dz01" --desired-status activated
		doublezero link create wan --code "ld4-dz01:frk-dz01" --contributor co01 --side-a ld4-dz01 --side-a-interface Switch1/1/2 --side-z frk-dz01 --side-z-interface Switch1/1/1 --bandwidth "10 Gbps" --delay-ms 25 --jitter-ms 10
