...
// DB represents a ClickHouse database connection
type DB interface {
...
func NewClient(ctx context.Context, log *slog.Logger, addr string, database string, username string, password string) (DB, error) {
