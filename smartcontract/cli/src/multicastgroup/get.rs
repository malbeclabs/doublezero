...
mod tests {
    ...
    fn test_cli_multicastgroup_get() {
        ...
        let user1_pk = Pubkey::from_str_const("11111115q4EpJaTXAZWpCg3J2zppWGSZ46KXozzo2");
        let user1 = User {
