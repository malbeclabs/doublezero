...
func TestQA_MultiTunnel(t *testing.T) {
	...
	log.Info("Phase 1: connecting all clients unicast")
	...
	log.Info("Phase 2: setting up multicast groups")
	...
	log.Info("Phase 3: adding multicast tunnels without disconnecting unicast")
	...
	log.Info("Phase 4: verifying IBRL tunnels still healthy")
	...
	log.Info("Phase 5: running connectivity validations")
