...
- CLI
  - `user subscribe` and `user create-subscribe` accept `--feed <PUBKEY|CODE>`, which an EdgeSeat access pass needs. It is optional: the feed is otherwise resolved from the pass. (#4099)
- Client daemon
