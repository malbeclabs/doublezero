...
func TestTelemetry_SflowProxy_Server_Run_StopsWorkersOnCancel(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_ReadLoop_ForwardsPackets(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_ReadLoop_IgnoresTimeouts(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_HealthLoop_AcceptThenCancel(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_HealthLoop_DoesNotFailOnTransientErrors(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_Ingest_InvalidDoesNotProduce(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_isClosedNetErr(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_ReadLoop_PermanentErrorExits(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_ReadLoop_SetDeadlineFailsFast(t *testing.T) {
	t.Parallel()
...
func TestTelemetry_SflowProxy_Server_Run_ReturnsFirstNonNilError(t *testing.T) {
	t.Parallel()
