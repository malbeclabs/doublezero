use doublezero_geolocation::{
    instructions::{GeolocationInstruction, RemoveParentDeviceArgs},
    pda,
...
pub struct RemoveParentDeviceCommand {
    pub code: String,
    pub device_pk: Pubkey,
    pub serviceability_globalstate_pk: Pubkey,
}

impl RemoveParentDeviceCommand {
...
mod tests {
    ...
    #[test]
    fn test_geolocation_geo_probe_remove_parent_device_command() {
        ...
        client
            ...
            .with(
                predicate::eq(GeolocationInstruction::RemoveParentDevice(
                    RemoveParentDeviceArgs { device_pk: device },
                )),
                predicate::eq(vec![
                    AccountMeta::new(probe_pda, false),
                    AccountMeta::new_readonly(config_pda, false),
        ...
        let command = RemoveParentDeviceCommand {
            code: code.to_string(),
            device_pk: device,
