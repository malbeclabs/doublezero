	...
	testCases := []struct {
		...
		},
		{
			...
			input: &serviceability.Device{
				...
				BumpSeed:               254,
				FacilityPubKey:         dummyPubKey,
				MetroPubKey:            dummyPubKey,
			...
			expected: `{
                ...
                "Index": {"High":0,"Low":2},
                "BumpSeed": 254,
                "FacilityPubKey": "` + dummyPubKeyB58 + `",
                "MetroPubKey": "` + dummyPubKeyB58 + `",
                ...
                "MaxUsers": 100,
                "UnicastUsersCount": 0,
                "MulticastSubscribersCount": 0,
                "MaxUnicastUsers": 0,
                "MaxMulticastSubscribers": 0,
                "ReservedSeats": 0,
                "MulticastPublishersCount": 0,
                "MaxMulticastPublishers": 0,
                "PubKey": "` + dummyPubKeyB58 + `"
            }`,
			expectErr: false,
		},
