...
**DoubleZero** is a decentralized network for high-performance distributed systems.

→ [Architecture docs](https://docs.malbeclabs.com/architecture/) · [Full documentation](https://docs.malbeclabs.com/)

## Development

For setup, testing, and local development workflows, see [DEVELOPMENT](./DEVELOPMENT.md).
