...
#[cfg(test)]
mod tests {
    use crate::allowlist::user::add::AddUserAllowlistCliCommand;
    use crate::allowlist::user::add::AddUserAllowlistCommand;
    use crate::requirements::{CHECK_BALANCE, CHECK_ID_JSON};
    ...
    fn test_cli_user_allowlist_add() {
        ...
        client
            ...
            .returning(|_| Ok(()));
        client
            .expect_add_user_allowlist()
            .with(predicate::eq(AddUserAllowlistCommand { pubkey }))
            .returning(move |_| Ok(signature));

        /*****************************************************************************************************/
        let mut output = Vec::new();
        let res = AddUserAllowlistCliCommand {
