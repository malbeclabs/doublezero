...
type mockTelemetryProgramClient struct {
	...
	GetInternetLatencySamplesFunc        func(ctx context.Context, dataProviderName string, originMetroPK solana.PublicKey, targetMetroPK solana.PublicKey, epoch uint64) (*telemetry.InternetLatencySamples, error)
}
...
func (c *mockTelemetryProgramClient) GetInternetLatencySamples(ctx context.Context, dataProviderName string, originMetroPK solana.PublicKey, targetMetroPK solana.PublicKey, epoch uint64) (*telemetry.InternetLatencySamples, error) {
	return c.GetInternetLatencySamplesFunc(ctx, dataProviderName, originMetroPK, targetMetroPK, epoch)
}
