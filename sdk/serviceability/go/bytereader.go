...
// ByteReader provides cursor-based reading of Borsh-serialized data.
...
func (br *ByteReader) ReadU128() Uint128 {
	...
	low := binary.LittleEndian.Uint64(br.data[br.offset:])
	high := binary.LittleEndian.Uint64(br.data[br.offset+8:])
	br.offset += 16
...
// ReadString reads a Borsh-encoded string (4-byte LE length prefix + UTF-8 bytes).
...
// ReadU32Slice reads a Borsh Vec<u32>.
