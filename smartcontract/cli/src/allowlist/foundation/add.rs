...
#[cfg(test)]
mod tests {
    use crate::allowlist::foundation::add::AddFoundationAllowlistCliCommand;
    use crate::allowlist::foundation::add::AddFoundationAllowlistCommand;
    use crate::requirements::{CHECK_BALANCE, CHECK_ID_JSON};
    ...
    #[test]
    fn test_cli_foundation_allowlist_add() {
        ...
        client
            ...
            .returning(|_| Ok(()));
        client
            .expect_add_foundation_allowlist()
            .with(predicate::eq(AddFoundationAllowlistCommand { pubkey }))
