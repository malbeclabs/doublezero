...
func TestMCP_Telemetry_Store_NewStore(t *testing.T) {
	t.Parallel()
...
func TestMCP_Telemetry_Store_CreateTablesIfNotExists(t *testing.T) {
	t.Parallel()
...
func TestMCP_Telemetry_Store_ReplaceDeviceLinkCircuits(t *testing.T) {
	t.Parallel()
...
func TestMCP_Telemetry_Store_AppendDeviceLinkLatencySamples(t *testing.T) {
	t.Parallel()
...
func TestMCP_Telemetry_Store_AppendInternetMetroLatencySamples(t *testing.T) {
	t.Parallel()
...
func TestMCP_Telemetry_Store_GetExistingMaxSampleIndices(t *testing.T) {
	t.Parallel()
...
func TestMCP_Telemetry_Store_GetExistingInternetMaxSampleIndices(t *testing.T) {
	t.Parallel()
