...
func TestFixtureDevice(t *testing.T) {
	...
	assertFields(t, meta.Fields, map[string]any{
		...
		"LocationPubKey":         solana.PublicKey(dev.LocationPubKey),
		"ExchangePubKey":         solana.PublicKey(dev.ExchangePubKey),
		"DeviceType":             uint8(dev.DeviceType),
		"Status":                 uint8(dev.Status),
		"MetricsPublisherPubKey": solana.PublicKey(dev.MetricsPublisherPubKey),
		"ContributorPubKey":      solana.PublicKey(dev.ContributorPubKey),
		"ReferenceCount":         dev.ReferenceCount,
		"UsersCount":             dev.UsersCount,
		"MaxUsers":               dev.MaxUsers,
		"DeviceHealth":           uint8(dev.DeviceHealth),
		"DeviceDesiredStatus":    uint8(dev.DeviceDesiredStatus),
	})
}
