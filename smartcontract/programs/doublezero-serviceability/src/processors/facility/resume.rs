...
pub struct FacilityResumeArgs {}

impl fmt::Debug for FacilityResumeArgs {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "")
    }
}

pub fn process_resume_facility(
    program_id: &Pubkey,
    accounts: &[AccountInfo],
    _value: &FacilityResumeArgs,
) -> ProgramResult {
    ...
    #[cfg(test)]
    msg!("process_resume_facility({:?})", _value);
