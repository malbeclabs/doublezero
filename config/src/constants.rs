...
pub const MAINNET_BETA_NAME: &str = "mainnet-beta";
pub const TESTNET_NAME: &str = "testnet";
pub const DEVNET_NAME: &str = "devnet";
pub const LOCALNET_NAME: &str = "local";

pub const MAINNET_BETA_SHORT_NAME: &str = "m";
pub const TESTNET_SHORT_NAME: &str = "t";
pub const DEVNET_SHORT_NAME: &str = "d";
pub const LOCALNET_SHORT_NAME: &str = "l";
