...
impl AddMulticastGroupPubAllowlistCliCommand {
    pub fn execute<C: CliCommand, W: Write>(self, client: &C, out: &mut W) -> eyre::Result<()> {
        ...
        let res = client
            .add_multicastgroup_pub_allowlist(AddMulticastGroupPubAllowlistCommand { pubkey })?;
...
#[cfg(test)]
mod tests {
    use crate::multicastgroup::allowlist::publisher::add::AddMulticastGroupAllowlistCliCommand;
    use crate::requirements::{CHECK_BALANCE, CHECK_ID_JSON};
    ...
    fn test_cli_user_allowlist_add() {
        ...
        client
            ...
            .returning(|_| Ok(()));
        client
            .expect_add_multicastgroup_pub_allowlist()
            .with(predicate::eq(AddMulticastGroupPubAllowlistCommand {
                pubkey,
            }))
