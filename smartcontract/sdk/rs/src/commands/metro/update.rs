...
use doublezero_serviceability::{
    ...
    processors::metro::update::MetroUpdateArgs,
};
use solana_sdk::{instruction::AccountMeta, pubkey::Pubkey, signature::Signature};

#[derive(Debug, PartialEq, Clone)]
pub struct UpdateMetroCommand {
    pub pubkey: Pubkey,
...
mod tests {
    use crate::{
        commands::metro::update::UpdateMetroCommand, tests::utils::create_test_client,
        DoubleZeroClient,
    };
    use doublezero_serviceability::{
    ...
    #[test]
    fn test_commands_metro_update_command() {
        ...
        client
            ...
            .with(
                predicate::eq(DoubleZeroInstruction::UpdateMetro(MetroUpdateArgs {
        ...
        let update_command = UpdateMetroCommand {
            pubkey: pda_pubkey,
            code: Some("test_exchange".to_string()),
            name: Some("Test Metro".to_string()),
            lat: Some(0.0),
        ...
        let update_invalid_command = UpdateMetroCommand {
