...
func TestE2E_SDK_Telemetry_DeviceLatencySamples(t *testing.T) {
	...
	_, err = dn.Manager.Exec(ctx, []string{"bash", "-c", `
		...
		doublezero device set-health --pubkey la2-dz01 --health ready-for-links
		doublezero device set-health --pubkey ny5-dz01 --health ready-for-links
		...
		doublezero device set-health --pubkey la2-dz01 --health ready-for-users
		doublezero device set-health --pubkey ny5-dz01 --health ready-for-users
