...
#[derive(Args, Debug)]
pub struct CreateExternalLinkCliCommand {
...
impl CreateExternalLinkCliCommand {
    pub fn execute<C: CliCommand, W: Write>(self, client: &C, out: &mut W) -> eyre::Result<()> {
        ...
        let (signature, _pubkey) = client.create_link(CreateLinkCommand {
            ...
            side_a_pk,
            side_z_pk,
            link_type: LinkLinkType::External,
...
mod tests {
    use crate::{
        doublezerocommand::CliCommand,
        link::external_create::CreateExternalLinkCliCommand,
        requirements::{CHECK_BALANCE, CHECK_ID_JSON},
    ...
    fn test_cli_link_create() {
        ...
        let res = CreateExternalLinkCliCommand {
            code: "test".to_string(),
