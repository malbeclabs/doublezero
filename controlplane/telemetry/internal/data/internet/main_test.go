...
type mockTelemetryClient struct {
	GetInternetLatencySamplesFunc func(ctx context.Context, dataProvider string, originMetroPK, targetMetroPK, collectorPK solana.PublicKey, epoch uint64) (*telemetry.InternetLatencySamples, error)
}

func (m *mockTelemetryClient) GetInternetLatencySamples(ctx context.Context, dataProvider string, originMetroPK, targetMetroPK, collectorPK solana.PublicKey, epoch uint64) (*telemetry.InternetLatencySamples, error) {
	return m.GetInternetLatencySamplesFunc(ctx, dataProvider, originMetroPK, targetMetroPK, collectorPK, epoch)
}
