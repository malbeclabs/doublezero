...
func TestAI_MCP_SQLTools_SchemaTool_Register(t *testing.T) {
	t.Parallel()
...
func TestAI_MCP_SQLTools_SchemaTool_HandleSchema(t *testing.T) {
	t.Parallel()
...
func TestAI_MCP_SQLTools_SchemaTool_ValidateSchema(t *testing.T) {
	t.Parallel()
...
func TestAI_MCP_SQLTools_SchemaTool_ValidateSchema_EdgeCases(t *testing.T) {
	t.Parallel()
