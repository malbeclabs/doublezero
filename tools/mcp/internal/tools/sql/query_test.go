...
func TestMCP_SQLTools_QueryTool_NewQueryTool(t *testing.T) {
	t.Parallel()
...
func TestMCP_SQLTools_QueryTool_Register(t *testing.T) {
	t.Parallel()
...
func TestMCP_SQLTools_QueryTool_HandleQuery(t *testing.T) {
	t.Parallel()
