...
pub struct AddDeviceAllowlistCliCommand {
    /// Contributor Pubkey to add to the allowlist
    #[arg(long)]
    pub pubkey: String,
}
...
mod tests {
    use crate::{
        allowlist::device::add::{AddDeviceAllowlistCliCommand, AddDeviceAllowlistCommand},
        requirements::{CHECK_BALANCE, CHECK_ID_JSON},
    ...
    #[test]
    fn test_cli_device_allowlist_add() {
        ...
        client
            ...
            .returning(|_| Ok(()));
        client
            .expect_add_device_allowlist()
            .with(predicate::eq(AddDeviceAllowlistCommand { pubkey }))
            .returning(move |_| Ok(signature));

        /*****************************************************************************************************/
        let mut output = Vec::new();
        let res = AddDeviceAllowlistCliCommand {
