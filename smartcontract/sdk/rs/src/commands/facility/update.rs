...
use doublezero_serviceability::{
    instructions::DoubleZeroInstruction, processors::facility::update::FacilityUpdateArgs,
};
...
mod tests {
    use crate::{
        commands::facility::update::UpdateFacilityCommand, tests::utils::create_test_client,
        DoubleZeroClient,
    };
    use doublezero_serviceability::{
        instructions::DoubleZeroInstruction,
        pda::{get_facility_pda, get_globalstate_pda},
        processors::facility::update::FacilityUpdateArgs,
    };
    use mockall::predicate;
    use solana_sdk::{instruction::AccountMeta, signature::Signature};

    #[test]
    fn test_commands_facility_update_command() {
        ...
        client
            ...
            .with(
                predicate::eq(DoubleZeroInstruction::UpdateFacility(FacilityUpdateArgs {
        ...
        let update_command = UpdateFacilityCommand {
            pubkey: pda_pubkey,
            code: Some("test_location".to_string()),
            name: Some("Test Facility".to_string()),
            country: Some("Test Country".to_string()),
        ...
        let update_invalid_command = UpdateFacilityCommand {
