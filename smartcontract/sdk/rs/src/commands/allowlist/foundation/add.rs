use double_zero_sla_program::{
    instructions::DoubleZeroInstruction, pda::get_globalstate_pda, processors::globalstate::foundation_allowlist::remove::RemoveFoundationAllowlistGlobalConfigArgs,
};
