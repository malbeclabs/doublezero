...
main() {
    ...
    solana-test-validator --reset --bpf-program ./bin/keypair.json ./bin/doublezero_serviceability.so >/tmp/solana.log 2>&1 &
...
populate_data_onchain() {
    ...
    print_banner "Populate link information onchain"
