...
./target/doublezero device set-health --pubkey la2-dz01 --health ready-for-links
./target/doublezero device set-health --pubkey la2-dz01 --health ready-for-users
./target/doublezero device update --pubkey la2-dz01 --desired-status activated
...
./target/doublezero device set-health --pubkey ny5-dz01 --health ready-for-links
./target/doublezero device set-health --pubkey ny5-dz01 --health ready-for-users
./target/doublezero device update --pubkey ny5-dz01 --desired-status activated
...
./target/doublezero device set-health --pubkey ld4-dz01 --health ready-for-links
### Order changed to test correct execution
./target/doublezero device update --pubkey ld4-dz01 --desired-status activated
./target/doublezero device set-health --pubkey ld4-dz01 --health ready-for-users
...
./target/doublezero device set-health --pubkey frk-dz01 --health ready-for-links
./target/doublezero device update --pubkey frk-dz01 --desired-status activated
### Order changed to test correct execution
./target/doublezero device set-health --pubkey frk-dz01 --health ready-for-users
...
./target/doublezero device update --pubkey sg1-dz01 --desired-status activated
./target/doublezero device set-health --pubkey sg1-dz01 --health ready-for-links
./target/doublezero device set-health --pubkey sg1-dz01 --health ready-for-users
...
./target/doublezero device update --pubkey ty2-dz01 --desired-status activated
./target/doublezero device set-health --pubkey ty2-dz01 --health ready-for-links
./target/doublezero device set-health --pubkey ty2-dz01 --health ready-for-users

./target/doublezero device create --code pit-dz01 --contributor co01 --location pit --exchange xpit --public-ip "204.16.241.243" --dz-prefixes "107.0.0.0/16" --metrics-publisher 1111111FVAiSujNZVgYSc27t6zUTWoKfAGxbRzzPB --mgmt-vrf mgmt -w
./target/doublezero device update --pubkey pit-dz01 --desired-status activated
./target/doublezero device set-health --pubkey pit-dz01 --health ready-for-links
./target/doublezero device set-health --pubkey pit-dz01 --health ready-for-users

./target/doublezero device create --code ams-dz01 --contributor co01 --location ams --exchange xams --public-ip "195.219.138.50" --dz-prefixes "108.0.0.0/16" --metrics-publisher 1111111FVAiSujNZVgYSc27t6zUTWoKfAGxbRzzPB --mgmt-vrf mgmt -w
./target/doublezero device update --pubkey ams-dz01 --desired-status activated
./target/doublezero device set-health --pubkey ams-dz01 --health ready-for-links
./target/doublezero device set-health --pubkey ams-dz01 --health ready-for-users
...
./target/doublezero link update --pubkey la2-dz01:ny5-dz01 --desired-status activated
./target/doublezero link set-health --pubkey la2-dz01:ny5-dz01 --health ready-for-service
...
./target/doublezero link set-health --pubkey ny5-dz01:ld4-dz01 --health ready-for-service
./target/doublezero link update --pubkey ny5-dz01:ld4-dz01 --desired-status activated
...
./target/doublezero link set-health --pubkey ld4-dz01:frk-dz01 --health ready-for-service
./target/doublezero link update --pubkey ld4-dz01:frk-dz01 --desired-status activated
...
./target/doublezero link set-health --pubkey ld4-dz01:sg1-dz01 --health ready-for-service
./target/doublezero link update --pubkey ld4-dz01:sg1-dz01 --desired-status activated
...
./target/doublezero link set-health --pubkey sg1-dz01:ty2-dz01 --health ready-for-service
./target/doublezero link update --pubkey sg1-dz01:ty2-dz01 --desired-status activated
...
./target/doublezero link set-health --pubkey ty2-dz01:la2-dz01 --health ready-for-service
./target/doublezero link update --pubkey ty2-dz01:la2-dz01 --desired-status activated
...
./target/doublezero device set-health --pubkey la2-dz02 --health ready-for-links
./target/doublezero device set-health --pubkey la2-dz02 --health ready-for-users
...
./target/doublezero link set-health --pubkey la2-dz02-la2-dz01 --health ready-for-service
