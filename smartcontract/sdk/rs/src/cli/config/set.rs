...
use crate::{convert_program_moniker, convert_url_moniker, convert_url_to_ws, convert_ws_moniker, read_doublezero_config, write_doublezero_config, DZClient};
...
impl SetConfigArgs {
    pub async fn execute(self, _: &DZClient) -> eyre::Result<()> {
        ...
        println!("Config File: {}\nRPC URL: {}\nWebSocket URL: {}\nKeypair Path: {}\nProgram ID: {}\n",
            ...
            config.keypair_path,
            config.program_id.unwrap_or(format!("{} (computed)",  crate::testnet::program_id::id())));
