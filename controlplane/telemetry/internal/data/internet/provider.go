...
type TelemetryClient interface {
	GetInternetLatencySamples(ctx context.Context, dataProvider string, originMetroPK, targetMetroPK solana.PublicKey, agentPK solana.PublicKey, epoch uint64) (*telemetry.InternetLatencySamples, error)
}
