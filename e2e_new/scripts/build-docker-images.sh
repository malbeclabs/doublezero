...
# TODO(snormore): Update this to e2e/docker after moving e2e_new/ to e2e/.
relative_dockerfiles_dir="e2e_new/docker"
...
docker build -t "${DZ_BASE_IMAGE}" -f "${dockerfiles_dir}/base.dockerfile" "${workspace_dir}"
