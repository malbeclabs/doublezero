...
func (dn *TestDevnet) Start(t *testing.T) (*devnet.Device, *devnet.Client) {
	...
	_, err = dn.Manager.Exec(ctx, []string{"bash", "-c", `
		...
		doublezero device update --pubkey ld4-dz01 --desired-status activated
		doublezero device set-health --pubkey ld4-dz01 --health ready-for-links
		doublezero device set-health --pubkey ld4-dz01 --health ready-for-users
		...
		doublezero device update --pubkey frk-dz01 --desired-status activated
		doublezero device set-health --pubkey frk-dz01 --health ready-for-links
		doublezero device set-health --pubkey frk-dz01 --health ready-for-users
		...
		doublezero device update --pubkey sg1-dz01 --desired-status activated
		doublezero device set-health --pubkey sg1-dz01 --health ready-for-links
		doublezero device set-health --pubkey sg1-dz01 --health ready-for-users
		...
		doublezero device update --pubkey ty2-dz01 --desired-status activated
		doublezero device set-health --pubkey ty2-dz01 --health ready-for-links
		doublezero device set-health --pubkey ty2-dz01 --health ready-for-users
		...
		doublezero device update --pubkey pit-dzd01 --desired-status activated
		doublezero device set-health --pubkey pit-dzd01 --health ready-for-links
		doublezero device set-health --pubkey pit-dzd01 --health ready-for-users
		...
		doublezero device set-health --pubkey ams-dz001 --health ready-for-links
		doublezero device set-health --pubkey ams-dz001 --health ready-for-users
		...
		doublezero link set-health --pubkey "ty2-dz01:la2-dz01" --health ready-for-service
		doublezero link update --pubkey     "ty2-dz01:la2-dz01" --desired-status activated
		...
		doublezero link set-health --pubkey "ny5-dz01:la2-dz01" --health ready-for-service
		doublezero link update --pubkey     "ny5-dz01:la2-dz01" --desired-status activated
		...
		doublezero link set-health --pubkey "ny5-dz01_e5:la2-dz01_e5" --health ready-for-service
		doublezero link update --pubkey     "ny5-dz01_e5:la2-dz01_e5" --desired-status activated
		...
		doublezero link set-health --pubkey "ny5-dz01_e6:la2-dz01_e6" --health ready-for-service
		doublezero link update --pubkey     "ny5-dz01_e6:la2-dz01_e6" --desired-status activated
