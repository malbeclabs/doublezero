...
cargo run -- --rpc-url "https://api.devnet.solana.com" Link create --contributor co01 --code "LA1-NY1" --side-a b26HEfQkk1DYawcpj9KYF5Wk6Bs6Q9rYWLbsxRoaFMH --side-z WnSXBCykWjuJDm8e1r5cen32JfoSNbKbxnW8bM5LKkr --Link-type 1 --bandwidth 100 --mtu 9000 --delay 15 --jitter 1
