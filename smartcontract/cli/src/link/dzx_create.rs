...
mod tests {
    ...
    use doublezero_serviceability::state::interface::{InterfaceCYOA, InterfaceType, LoopbackType};
    ...
    fn test_cli_dzx_link_create() {
        ...
        let device1 = Device {
            ...
            code: "test".to_string(),
            contributor_pk,
            facility_pk: location1_pk,
            metro_pk: exchange1_pk,
        ...
        let device2 = Device {
            ...
            code: "test".to_string(),
            contributor_pk,
            facility_pk: location2_pk,
            metro_pk: exchange2_pk,
            device_type: DeviceType::Hybrid,
            public_ip: [10, 0, 0, 1].into(),
            dz_prefixes: "10.1.0.0/16".parse().unwrap(),
            metrics_publisher_pk: Pubkey::default(),
        ...
        let device3 = Device {
            ...
            code: "test".to_string(),
            contributor_pk,
            facility_pk: location3_pk,
            metro_pk: exchange3_pk,
            device_type: DeviceType::Hybrid,
            public_ip: [10, 0, 0, 1].into(),
            dz_prefixes: "10.1.0.0/16".parse().unwrap(),
            metrics_publisher_pk: Pubkey::default(),
    ...
    #[test]
    fn test_cli_dzx_link_create_rejects_cyoa_interface() {
        let mut client = create_test_client();
