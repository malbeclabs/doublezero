    ...
    def test_deserialize(self):
        ...
        _assert_fields(
            meta["fields"],
            {
                ...
                "UnicastUsersCount": dev.unicast_users_count,
                "MulticastSubscribersCount": dev.multicast_subscribers_count,
                "MaxUnicastUsers": dev.max_unicast_users,
                "MaxMulticastSubscribers": dev.max_multicast_subscribers,
                "ReservedSeats": dev.reserved_seats,
                "MulticastPublishersCount": dev.multicast_publishers_count,
                "MaxMulticastPublishers": dev.max_multicast_publishers,
