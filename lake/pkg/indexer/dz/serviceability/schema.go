...
func (s *ContributorSchema) ToRow(c Contributor) []interface{} {
	return []interface{}{c.PK, c.Code, c.Name}
}
...
func (s *DeviceSchema) ToRow(d Device) []interface{} {
	return []interface{}{
		d.PK,
		d.Status,
		d.DeviceType,
...
func (s *UserSchema) ToRow(u User) []interface{} {
	return []interface{}{
		u.PK,
		u.OwnerPubkey,
		u.Status,
...
func (s *MetroSchema) ToRow(m Metro) []interface{} {
	return []interface{}{
		m.PK,
		m.Code,
		m.Name,
...
func (s *LinkSchema) ToRow(l Link) []interface{} {
	return []interface{}{
		l.PK,
		l.Status,
		l.Code,
