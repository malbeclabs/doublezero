...
mod tests {
    ...
    fn test_cli_link_latency_p99() {
        ...
        assert!(!output_str.contains("P50 (ms)"), "Should NOT have P50 column");
        assert!(!output_str.contains("P90 (ms)"), "Should NOT have P90 column");
        assert!(!output_str.contains("P95 (ms)"), "Should NOT have P95 column");
        assert!(!output_str.contains("Mean (ms)"), "Should NOT have Mean column");
        assert!(!output_str.contains("StdDev (ms)"), "Should NOT have StdDev column");
    ...
    fn test_cli_link_latency_p50() {
        ...
        assert!(!output_str.contains("P90 (ms)"), "Should NOT have P90 column");
        assert!(!output_str.contains("P95 (ms)"), "Should NOT have P95 column");
        assert!(!output_str.contains("P99 (ms)"), "Should NOT have P99 column");
        assert!(!output_str.contains("Mean (ms)"), "Should NOT have Mean column");
        assert!(!output_str.contains("StdDev (ms)"), "Should NOT have StdDev column");
    ...
    fn test_cli_link_latency_invalid_percentile() {
        ...
        assert!(err.to_string().contains("Invalid percentile"), "Error should mention invalid percentile");
        assert!(err.to_string().contains("invalid"), "Error should include the invalid value");
        assert!(err.to_string().contains("p50"), "Error should list valid options");
    }
