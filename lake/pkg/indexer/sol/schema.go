...
func (s *LeaderScheduleSchema) ToRow(entry LeaderScheduleEntry, epoch uint64) []interface{} {
...
func (s *VoteAccountSchema) ToRow(account solanarpc.VoteAccountsResult, epoch uint64) []interface{} {
...
func (s *GossipNodeSchema) ToRow(node *solanarpc.GetClusterNodesResult, epoch uint64) []interface{} {
...
func (s *BlockProductionSchema) ToRow(entry BlockProductionEntry, ingestedAt time.Time) []interface{} {
	return []interface{}{
		entry.Epoch,
		entry.Time.UTC(),
		ingestedAt,
